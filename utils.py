...
async def get_gpt4_responses(user_message: str, style: str, session_id: str, user_response: str = None):
    ...
    # Si hay una respuesta del oyente (puede ser seleccionada o personalizada)
    if user_response:
